...
const EquipmentBrandsCreate: FC<any> = (): ReactElement => {
    ...
    return (
        <Box sx={{
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={8}>
                    <Typography variant="h3">لیست برندها</Typography>
                ...
                <Grid item xs={4}>
                    <Card variant="outlined" sx={{ padding: 2 }}>
                        <Stack
                            ...
                            >
                                <Typography variant="h3">ثبت برند</Typography>
...
export default EquipmentBrandsCreate;